...
import 'package:ameen/view/ui/driver/morning/morning_trip.dart';
...
import 'evening/evening_trip.dart';

String name = "سعد عبدالله";
    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          Text(name,
              style: TextStyle(fontSize: width * 0.08, color: PRIMARY_COLOR)),
          ...
          GestureDetector(
            ...
            child: Container(
              decoration: UnderlineTabIndicator(
                  insets: EdgeInsets.symmetric(horizontal: width * 0.045),
                  borderSide:
                      const BorderSide(color: PRIMARY_COLOR, width: 1.7)),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("معلوماتي",
                      style: TextStyle(
                          fontSize: width * 0.04, color: PRIMARY_COLOR)),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Icon(Icons.task, size: width * 0.05, color: PRIMARY_COLOR),
                  Text("قائمة الطلاب",
                      style: TextStyle(
                          fontSize: width * 0.04, color: PRIMARY_COLOR)),
                  Icon(Icons.arrow_forward_ios_outlined,
          ...
          GestureDetector(
            onTap: () {
              Get.dialog(
                CustomDialog(
                    buttonText: 'نعم', content: 'هل انت متأكد من حالة الطوائ'),
              );
            },
            child: Container(
              decoration: UnderlineTabIndicator(
